...
const stream = fs.createWriteStream("fixed-feed.xml");
let linecount = 0;
let pausedCount = 0;
let activeCount = 0;
    ...
    es
      .mapSync(function (line) {
        ...
        if (line.includes("opening_time")) {
          let findJson = /\{(.*)\}/g;
          const extractedJson = line.match(findJson).toString();
          ...
          const currentUTCHour = `${fixedHours}:${fixedMinutes}`;
          ...
          if (
            ...
            if (
              parsedJson[`${yesterday}`] === undefined ||
              parsedJson[`${yesterday}`][0] === undefined
            ) {
              isActive = false;
              pausedCount++;
              console.log(
                `case1.pausing line ${linecount}. Opening hours undefined and prev day undefined`
              );
            } else {
              let openingHourForPrevDay = parsedJson[`${yesterday}`][0].opening;
              let closingHourForPrevDay = parsedJson[`${yesterday}`][0].closing;
              if (
                closingHourForPrevDay < openingHourForPrevDay &&
                currentUTCHour < closingHourForPrevDay
              ) {
                isActive = true;
                activeCount++;
                console.log(
                  `case2.adding line: ${linecount} this day is undefined but prev day saved the day!`
                );
              } else {
                isActive = false;
                pausedCount++;
                console.log(
                  `case3.pausing line ${linecount}. Opening hours undefined. Prev. day hours defined and closing before midnight or before now`
                );
              }
            }
            ...
            let openingHourForCurrentDay = parsedJson[`${today}`][0].opening;
            let closingHourForCurrentDay = parsedJson[`${today}`][0].closing;
            ...
            if (closingHourForCurrentDay < openingHourForCurrentDay) {
              ...
              if (openingHourForCurrentDay < currentUTCHour) {
                ...
                activeCount++;
                console.log(
                  `case4.adding line: ${linecount} closingHour < openingHour and now is after opening`
                );
              } else {
                ...
                if (
                  ...
                  pausedCount++;
                  console.log(
                    `case5.pausing line ${linecount}. closingHour < openingHour and prev day undefined`
                  );
                } else {
                  let openingHourForPrevDay =
                    parsedJson[`${yesterday}`][0].opening;
                  let closingHourForPrevDay =
                    parsedJson[`${yesterday}`][0].closing;
                  ...
                  if (
                    ...
                    activeCount++;
                    console.log(
                      `case6.adding line: ${linecount} prev day hours saves the day!`
                    );
                  } else {
                    isActive = false;
                    pausedCount++;
                    console.log(
                      `case7.pausing line1: ${linecount} openingHour < closingHour and now is before opening and prev day not saves`
                    );
                  }
                }
              }
            ...
            // now is between opening and closing hours
              ...
              openingHourForCurrentDay < currentUTCHour &&
              ...
              if (
                ...
                pausedCount++;
                console.log(
                  `case8.pausing line: ${linecount} not between opening hours and prev day is empty`
                );
              } else {
                let openingHourForPrevDay =
                  parsedJson[`${yesterday}`][0].opening;
                ...
                if (
                  ...
                  activeCount++;
                  console.log(
                    `case9.adding line: ${linecount} prev day hours saves the day!`
                  );
                } else {
                  isActive = false;
                  pausedCount++;
                  console.log(
                    `case10.pausing line: ${linecount}  openingHour < closingHour and now is not between opening-closing and prev. day defined but doesn't activate the offer`
                  );
                }
              }
            }
      ...
      .on("end", function () {
        ...
        console.log(
          `this many paused: ${pausedCount} and this many active: ${activeCount}`
        );
      })
  );
